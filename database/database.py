...
class DataBase:
    ...
    def insert_order(self, customer_name):
        sql = '''INSERT INTO orders(cutomer_name)
        VALUES (%s) returning *'''
        return self.manager(sql, customer_name, fetchone=True)

    def insert_product_item(self, product_name, product_quantity, product_price, product_total_price, order_id):
        sql = '''INSERT INTO orderitem(product_name, product_quantity, product_price, product_total_price, order_id)
        VALUES (%s, %s, %s, %s, %s)'''
